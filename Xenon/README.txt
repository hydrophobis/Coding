...
CamoGekko@repository > I have converted this into a CSGO cheat engine
CamoGekko@repository > Everything you need has been labeled in the first comment in every file
CamoGekko@repository > important --files
MaxRecoil.cs SendInput.cs MindControlAction.cs Debug.cs Player.cs Entity.cs EntityBase.cs
CamoGekko@repository > Everything to get started is there
CamoGekko@repository > Also take a peek at the utils folder, it has stuff youll need